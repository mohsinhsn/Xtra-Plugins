...
@stylish_on_cmd(
    ...
    info={
        ...
        "examples": "{tr}fmusical StylishUB",
    },
)
...
@stylish_on_cmd(
    ...
    info={
        ...
        "examples": "{tr}smallcaps StylishUB",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
...
@stylish_on_cmd(
    ...
    info={
        ...
        "examples": "{tr}smothtext StylishUB",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
