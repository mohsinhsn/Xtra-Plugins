...
@stylish_on_cmd(
    ["radio"],
    is_official=False,
    cmd_help={"help": "Play Radio.", "example": "{ch}radio (radio url)"},
)
...
@stylish_on_cmd(
    ["stopradio"],
    is_official=False,
    cmd_help={"help": "Stop Radio.", "example": "{ch}stopradio"},
)
...
@stylish_on_cmd(
    ["rejoin"],
    is_official=False,
    cmd_help={"help": "Rejoin Voice Chat!", "example": "{ch}rejoin"},
)
...
@stylish_on_cmd(
    ...
    cmd_help={
        ...
        "example": "{ch}setvol (Specifically Volume Between 2-100)",
    },
)
